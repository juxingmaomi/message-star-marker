...
- 列表支持按全部 / 星标 / 爱心筛选，点击楼层可跳转，也可直接取消对应标记。
- 如果楼层正文里有 `<Scene_Title>标题</Scene_Title>`，列表会显示这个标题。
- 点击很早的懒加载楼层时，会先调用酒馆助手 `/chat-jump` 请求加载，再补扫星心按钮。
...
```js
https://cdn.jsdelivr.net/gh/YOUR_GITHUB_USERNAME/message-star-marker@v0.4.5/index.js
```
