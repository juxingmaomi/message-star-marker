...
- 点击很早的懒加载楼层时，会先调用酒馆助手 `/chat-jump` 请求加载；如果仍未渲染，会分帧临时显示目标楼层前后各 3 楼，并可在面板里恢复完整聊天。
...
```js
https://cdn.jsdelivr.net/gh/YOUR_GITHUB_USERNAME/message-star-marker@v0.5.1/index.js
```
