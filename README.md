...
- 手机端会在页面恢复或重新可见时自动补回面板入口，并兼容“星心面板 / 星心列表”等历史按钮名称。
...
```js
https://cdn.jsdelivr.net/gh/YOUR_GITHUB_USERNAME/message-star-marker@v0.5.4/index.js
```
