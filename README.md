...
- 点击 TavernHelper 唯一的 `楼层书签跳转` 按钮时打开标记列表。
...
- 入口完全使用 TavernHelper 官方脚本按钮；手机端列表面板挂载到官方移动浮窗容器 `#movingDivs`。
...
```js
https://cdn.jsdelivr.net/gh/YOUR_GITHUB_USERNAME/message-star-marker@v0.6.0/index.js
```
